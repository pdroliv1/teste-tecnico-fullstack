...
### Backend
- Linguagem: Python 3
- Framework: Flask (pela leveza e simplicidade).
- Banco de Dados: SQLite

Nota sobre o Banco de Dados:
Embora o teste sugerisse PostgreSQL/Mongo, optei intencionalmente pelo SQLite para garantir Portabilidade e Developer Experience (DX). Isso permite que o avaliador rode o teste imediatamente, sem configurar Docker ou credenciais locais.
